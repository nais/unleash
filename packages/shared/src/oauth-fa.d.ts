 ...
 * @type {string}
 */
export declare const OAUTH_JWT_HEADER: string;
/**
 * The issuer of the IAP JWT token.
 * @type {string}
 */
export declare const OAUTH_JWT_ISSUER: string;
/**
 * The URL to the OAuth JWT keyset.
 * @type {string}
 */
export declare const OAUTH_JWT_KEYSET: string;
/**
 * The audience of the IAP JWT token.
 * @type {string}
 */
export declare const OAUTH_JWT_AUDIENCE: string;
/**
 * The time in milliseconds to cache the user validation result.
 * @type {number}
 */
export declare const API_USER_VALIDATION_CACHE_TIME: number;
/**
 ...
 */
declare function createJWTAuthHandler(teamsServer: TeamsService): Promise<(app: any, config: any, services: any) => void>;
